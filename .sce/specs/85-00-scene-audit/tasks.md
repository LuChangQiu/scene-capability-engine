...
- [x]* 3. Write tests
  - [x]* 3.1 Write unit tests for audit command
  ...
  - [x]* 3.2 Write property test: summary counts invariant
    - **Property 1: Summary counts are consistent with index contents**
    - **Validates: Requirements 1.1, 6.1**
  - [x]* 3.3 Write property test: missing tarball detection is exact
    - **Property 2: Missing tarball detection is exact**
    - **Validates: Requirements 2.1, 2.2**
  - [x]* 3.4 Write property test: integrity mismatch detection is exact
    - **Property 3: Integrity mismatch detection is exact**
    - **Validates: Requirements 3.1, 3.2**
  - [x]* 3.5 Write property test: orphaned tarball detection is exact
    - **Property 4: Orphaned tarball detection is exact**
    - **Validates: Requirements 4.1, 4.2**
  - [x]* 3.6 Write property test: deprecated version reporting is exact
    - **Property 5: Deprecated version reporting is exact**
    - **Validates: Requirements 5.1**
  - [x]* 3.7 Write property test: fix mode cleanup
