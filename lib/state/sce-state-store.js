...
class SceStateStore {
  ...
  async listOntologyErAssets(options = {}) {
    ...
    params.push(limit);
    return this._db.prepare(sql).all(...params).map((row) => this._mapOntologyErAssetRow(row));
  }
  ...
  async getOntologyErAsset(entityId) {
    ...
    if (!await this.ensureReady()) return null;
    return this._mapOntologyErAssetRow(this._db.prepare('SELECT * FROM ontology_er_asset_registry WHERE entity_id = ?').get(normalizedId));
  }
  ...
  async listOntologyBrRules(options = {}) {
    ...
    params.push(limit);
    return this._db.prepare(sql).all(...params).map((row) => this._mapOntologyBrRuleRow(row));
  }
  ...
  async getOntologyBrRule(ruleId) {
    ...
    if (!await this.ensureReady()) return null;
    return this._mapOntologyBrRuleRow(this._db.prepare('SELECT * FROM ontology_br_rule_registry WHERE rule_id = ?').get(normalizedId));
  }
  ...
  async listOntologyDlChains(options = {}) {
    ...
    params.push(limit);
    return this._db.prepare(sql).all(...params).map((row) => this._mapOntologyDlChainRow(row));
  }
  ...
  async getOntologyDlChain(chainId) {
    ...
    if (!await this.ensureReady()) return null;
    return this._mapOntologyDlChainRow(this._db.prepare('SELECT * FROM ontology_dl_chain_registry WHERE chain_id = ?').get(normalizedId));
  }
  ...
  async listAssuranceResourceSnapshots(options = {}) {
    ...
    params.push(limit);
    return this._db.prepare(sql).all(...params).map((row) => this._mapAssuranceResourceSnapshotRow(row));
  }
  ...
  async listAssuranceLogViews(options = {}) {
    ...
    params.push(limit);
    return this._db.prepare(sql).all(...params).map((row) => this._mapAssuranceLogViewRow(row));
  }
  ...
  async listAssuranceBackupRecords(options = {}) {
    ...
    params.push(limit);
    return this._db.prepare(sql).all(...params).map((row) => this._mapAssuranceBackupRecordRow(row));
  }
  ...
  async listAssuranceConfigSwitches(options = {}) {
    ...
    params.push(limit);
    return this._db.prepare(sql).all(...params).map((row) => this._mapAssuranceConfigSwitchRow(row));
  }
